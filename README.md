...
openstack_cinder_volume_status_counter| status="attaching"                                                                                                                                                                                                                                                                                                   |0.0 (float)| Volume status counter
...
openstack_cinder_volume_type_quota_gigabytes| tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",volume_type="lvmdriver-1"                                                                                                                                                                                                                                    |1000.0 (float)| Volume type quota in gigabytes
...
openstack_container_infra_total_clusters| region="RegionOne"                                                                                                                                                                                                                                                                                           |1.0 (float)| Total number of clusters
openstack_container_infra_up| region="RegionOne"                                                                                                                                                                                                                                                                                                       |1.0 (float)| Service status (1=up, 0=down)
...
openstack_designate_up| region="RegionOne"                                                                                                                                                                                                                                                                                                            |1.0 (float)| Service status (1=up, 0=down)
...
openstack_gnocchi_status_metric_having_measures_to_process| region="RegionOne"                                                                                                                                                                                                                                                                      |291.0 (float)| Number of metrics having measures to process
openstack_gnocchi_status_metricd_processors| region="RegionOne"                                                                                                                                                                                                                                                                                       |8.0 (float)| Number of metricd processors
openstack_gnocchi_total_metrics| region="RegionOne"                                                                                                                                                                                                                                                                                                     |2759.0 (float)| Total number of metrics
openstack_gnocchi_up| region="RegionOne"                                                                                                                                                                                                                                                                                                              |1.0 (float)| Service status (1=up, 0=down)
...
openstack_heat_up| region="RegionOne"                                                                                                                                                                                                                                                                                                                 |1.0 (float)| Service status (1=up, 0=down)
openstack_identity_domain_info| description="Owns users and tenants (i.e. projects) available on Identity API v2.",enabled="true",id="default",name="Default"                                                                                                                                                                                               |1.0 (float)| Domain information
...
openstack_identity_up| region="RegionOne"                                                                                                                                                                                                                                                                                                             |1.0 (float)| Service status (1=up, 0=down)
openstack_identity_users| region="RegionOne"                                                                                                                                                                                                                                                                                                    |30.0 (float)| Total number of users
openstack_ironic_node| id="c9f98cc9-25e9-424e-8a89-002989054ec2",name="r1-05",provision_state="available",power_state="power off",maintenance="true",maintenance_reason="Firmware upgrade",console_enabled="true",resource_class="baremetal",deploy_kernel="7ff5ef56-daaa-4256-9dd8-c3f1f9964ebc",deploy_ramdisk="e9c96d45-a4c8-4165-8753-9d8f32779e99",retired="true",retired_reason="No longer needed" |1 (float)| Ironic node information
openstack_ironic_node_provision_updated_at| id="c9f98cc9-25e9-424e-8a89-002989054ec2",name="r1-05",provision_state="available"                                                                                                                                                                                                                                            |1.562908443e+09 (float)| Unix timestamp of the last provision state update
openstack_ironic_node_updated_at| id="c9f98cc9-25e9-424e-8a89-002989054ec2",name="r1-05",provision_state="available"                                                                                                                                                                                                                                                      |1.592845911e+09 (float)| Unix timestamp of the last node update
openstack_ironic_up| region="RegionOne"                                                                                                                                                                                                                                                                                                              |1.0 (float)| Service status (1=up, 0=down)
...
openstack_neutron_ports_lb_not_active| region="RegionOne"                                                                                                                                                                                                                                                                                             |1.0 (float)| Number of load-balancer ports not active
openstack_neutron_ports_no_ips| region="RegionOne"                                                                                                                                                                                                                                                                                                    |1.0 (float)| Number of ports without IPs
openstack_neutron_ports| region="RegionOne"                                                                                                                                                                                                                                                                                                    | 1063.0 (float)| Total number of ports
openstack_neutron_port| admin_state_up="true",binding_vif_type="",device_id="9ae135f4-b6e0-4dad-9e91-3c223e385824",device_owner="network:router_gateway",fixed_ips="",mac_address="fa:16:3e:58:42:ed",network_id="70c1db1f-b701-45bd-96e0-a313ee3430b3",status="ACTIVE",uuid="d80b1a3b-4fc1-49f3-952e-1e2ab7081d8b" |1.0 (float)| Port information
openstack_neutron_quota_floatingip|tenant="admin",type="used"                                                                                                                                                                                                                                                                                                      |1 (float)|Current usage of floating ips for the tenant
openstack_neutron_quota_network|tenant="admin",type="used"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of networks for the tenant
openstack_neutron_quota_port|tenant="admin",type="used"                                                                                                                                                                                                                                                                            |1 (float)|Current usage of ports for the tenant
openstack_neutron_quota_rbac_policy|tenant="admin",type="used"                                                                                                                                                                                                                                              |1 (float)|Current usage of rbac policies for the tenant
openstack_neutron_quota_router| tenant="admin",tenant_id="0c4e939acacf4376bdcd1129f1a054ad",type="limit"                                                                                                                                                                                                                                                |10.0 (float)| Router quota usage for the tenant
openstack_neutron_quota_security_group_rule|tenant="admin",type="used"                                                                                                                                                                                                                                                    |1 (float)|Current usage of security group rules for the tenant
openstack_neutron_quota_security_group|tenant="admin",type="used"                                                                                                                                                                                                                                                                        |1 (float)|Current usage of security groups for the tenant
openstack_neutron_quota_subnetpool|tenant="admin",type="used"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of subnet pools for the tenant
openstack_neutron_quota_subnet|tenant="admin",type="used"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of subnets for the tenant
openstack_neutron_routers_not_active| region="RegionOne"                                                                                                                                                                                                                                                                                              |1.0 (float)| Number of routers not active
...
openstack_neutron_up| region="RegionOne"                                                                                                                                                                                                                                                                                                             |1.0 (float)| Service status (1=up, 0=down)
...
openstack_nova_current_workload| aggregates="",availability_zone="",hostname="host1"                                                                                                                                                                                                                                                                    |0.0 (float)| Current workload
...
openstack_nova_quota_cores|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                                                      |1 (float)|Current usage of cores for the tenant
openstack_nova_quota_fixed_ips|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of fixed IPs for the tenant
openstack_nova_quota_floating_ips|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                            |1 (float)|Current usage of floating IPs for the tenant
openstack_nova_quota_injected_file_content_bytes|tenant="admin",type="in_use"                                                                                                                                                                                                                                              |1 (float)|Current usage of injected file content bytes for the tenant
openstack_nova_quota_injected_file_path_bytes|tenant="admin",type="in_use"                                                                                                                                                                                                                                                    |1 (float)|Current usage of injected file path bytes for the tenant
openstack_nova_quota_injected_files|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                        |1 (float)|Current usage of injected files for the tenant
openstack_nova_quota_instances|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of instances for the tenant
openstack_nova_quota_key_pairs|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                                  |1 (float)|Current usage of key pairs for the tenant
openstack_nova_quota_metadata_items|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                        |1 (float)|Current usage of metadata items for the tenant
openstack_nova_quota_ram|tenant="admin",type="in_use"                                                                                                                                                                                                                                                                                              |1 (float)|Current usage of RAM for the tenant
openstack_nova_quota_security_group_rules|tenant="admin",type="in_use"                                                                                                                                                                                                                                                            |1 (float)|Current usage of security group rules for the tenant
...
openstack_nova_up| region="RegionOne"                                                                                                                                                                                                                                                                                                                |1.0 (float)| Service status (1=up, 0=down)
...
openstack_object_store_up| region="RegionOne"                                                                                                                                                                                                                                                                                                         |1.0 (float)| Service status (1=up, 0=down)
...
openstack_sharev2_share_status_counter| status="available"                                                                                                                                                                                                                                                                                             |1.0 (float)| Share status counter
openstack_sharev2_share_status| id="4be93e2e-ffff-ffff-ffff-603e3ec2a5d6",name="share-test",project_id="ffff8fa0ca1a468db8ad00970c1effff",share_proto="NFS",share_type="az1",share_type_name="",size="1",status="available"                                                                                                                                    |1.0 (float)| Share status
openstack_sharev2_shares_counter| region="RegionOne"                                                                                                                                                                                                                                                                                                    |1.0 (float)| Total number of shares
openstack_sharev2_up| region="RegionOne"                                                                                                                                                                                                                                                                                                              |1.0 (float)| Service status (1=up, 0=down)
...
openstack_trove_total_instances| region="RegionOne"                                                                                                                                                                                                                                                                                                     |1.0 (float)| Total number of database instances
openstack_trove_up| region="RegionOne"                                                                                                                                                                                                                                                                                                               |1.0 (float)| Service status (1=up, 0=down)
